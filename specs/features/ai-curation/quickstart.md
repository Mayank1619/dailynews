# Quickstart - AI Summarization + Ranking (Curation)

## Goal
Validate the Phase 1 implementation slice for ai-curation.
...
## Steps
1. Load fixtures relevant to ai-curation from local emulator data.
...
## Verification
- Core acceptance scenario passes for ai-curation.
