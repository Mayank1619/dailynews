# Implementation Plan: Blog + SEO Pages

**Branch**: $(System.Collections.Hashtable.branch) | **Date**: 2026-05-26 | **Spec**: /specs/features/blog-seo/spec.md

**Input**: Feature specification from /specs/features/blog-seo/spec.md

## Summary

Publish SEO-ready blog index and article pages with canonical metadata and discoverability support.
...
**Primary Dependencies**: Next.js 15 (App Router), Node.js 22, TypeScript 5, Cloud Functions for Firebase, Cloud Firestore, Firebase Admin SDK, Next.js metadata + sitemap generation
...
**Performance Goals**: Server render under 500ms p95 for cached pages.

**Constraints**: Published-only exposure; canonical URLs and OG metadata required.

**Scale/Scope**: 10k published posts over time.

## Constitution Check

*GATE: Must pass before Phase 0 research. Re-check after Phase 1 design.*

- Fast value gate: PASS - Public blog routes, metadata generation, sitemap inclusion, and published-only content visibility.
