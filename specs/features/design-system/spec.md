...
- **FR-004**: The system MUST define typography guidance with serif-led headings and sans-serif body text, using Playfair Display or a similar serif for headings, Inter or a similar sans-serif for body text, and a scale of H1 32px bold, H2 24px semi-bold, H3 18px medium, and body text at 14-16px.
